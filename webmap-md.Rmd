...
By either clicking or zooming on the clusters, finer granularity can be observed until individual markers associated with each cluster enter the browser's viewport. Individual markers are clickable and provide: a crime description, date of occurence, location and outcome status if available.  
